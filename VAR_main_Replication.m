...
% =========================================================================
% Modified version of Gertler & Karadi (2015) VAR_main.m
%
% Key improvements vs your current version:
%   1) Safe date arithmetic using datetime + calmonths (no invalid months)
%   2) Robust date indexing: asserts unique matches for start/end dates
%   3) Cleaner factor label handling (no mismatched label arrays)
%   4) Output directory is relative to this file's location (not pwd)
%   5) Keeps proxy ordering and Cholesky comparison exactly as intended
%
% =========================================================================
